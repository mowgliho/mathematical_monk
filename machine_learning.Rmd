...
- Thinking "Graphically"/Network
  - Setup 1
    ...
    - Notation: $B\perp C |A$ signifies that $B$ is conditionally independent of $C$ given $A$.
    - If $B\perp C|A$, then $p(c|a,b) = p(c|a)$
  ...
  - Setup 3
    - Given a DAG, we can follow the edges and reverse engineer a rule for probability distribution.
      - $p(x_1,\dots,x_n) = \prod_i p(x_i|S_i)$, where $S_i$ are the $x_j$ with arrows that go to $x_i$
